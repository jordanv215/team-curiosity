...
class LoginSource implements \JsonSerializable {
	 ...
	 **/
	public function __construct(int $newLoginSourceId = null, string $newLoginSourceProvider) {
		try {
	...
	public function insert(\PDO $pdo) {
		...
		$query = "INSERT INTO LoginSource(loginSourceId, loginSourceProvider) VALUES(:loginSourceId, :loginSourceProvider)";
		$statement = $pdo->prepare($query);

		// bind the member variables to the place holders in the template
		$parameters = ["loginSourceId" => $this->loginSourceId, "loginSourceProvider" => $this->loginSourceProvider];
	...
	public function update(\PDO $pdo) {
		...
		// create query template
		$query = "UPDATE LoginSource SET loginSourceId = :loginSourceId, loginSourceProvider = :loginSourceProvider WHERE loginSourceId = :loginSourceId";
		$statement = $pdo->prepare($query);
	...
	public static function getLoginSourceByLoginSourceId(\PDO $pdo, int $loginSourceId) {
		...
		// create query template
		$query = "SELECT loginSourceId, loginSourceProvider FROM LoginSource WHERE loginSourceId = :loginSourceId";
		$statement = $pdo->prepare($query);
		...
		// grab the data from the table
			try {
				...
				$row = $statement->fetch();
				if($row !== false) {
					$loginSource = new LoginSource($row["loginSourceId"], $row["loginSourceProvider"]);
				}
			} catch(\Exception $exception) {
	...
	public static function getLoginSourceByLoginSourceProvider(\PDO $pdo, string $loginSourceProvider) {
		...
		// create query template
		$query = "SELECT loginSourceId, loginSourceProvider FROM LoginSource WHERE loginSourceProvider LIKE :loginSourceProvider";
		$statement = $pdo->prepare($query);
	...
	public static function getAllLoginSources(\PDO $pdo) {
		// create query template
		$query = "SELECT loginSourceId, loginSourceProvider FROM LoginSource";
		$statement = $pdo->prepare($query);
		$statement->execute();
