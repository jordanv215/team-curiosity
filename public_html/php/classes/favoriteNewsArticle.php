 ...
 **/
private
$favoriteNewsArticleNewsArticleId;
 ...
 **/
public
function __construct(int $newFavoriteNewsArticleNewsArticleId = null, int $newFavoriteNewsArticleUserId, $newFavoriteNewsArticleDateTime = null) {
	try {
 ...
 **/
public
function getFavoriteNewsArticleNewsArticleId() {
 ...
 **/
public
function setFavoriteNewsArticleNewsArticleId(int $newFavoriteNewsArticleNewsArticleId) {
 ...
 **/
public
function getFavoriteNewsArticleUserId() {
 ...
 **/
public
function setFavoriteNewsArticleUserId(int $newFavoriteNewsArticleUserId) {
 ...
 **/
public
function getFavoriteNewsArticleDateTime() {
 ...
 **/
public
function setFavoriteNewsArticleDateTime($newFavoriteNewsArticleDateTime = null) {
 ...
 **/
public
static function getFavoriteNewsArticlebyFavoriteNewsArticleFavoriteNewsArticleId(\PDO $pdo, int $favoriteNewsArticleNewsArticleId) {
 ...
 **/
public
static function getfavoriteNewsArticleByfavoriteNewsArticleUserId(\PDO $pdo, int $favoriteNewsArticleUserId) {
 ...
 **/
public
static function getAllFavoriteNewsArticle(\PDO $pdo) {
	// create query template
